...
In CaMPL, a programmer may build custom types from the built-in types using {\tt protocol} keyword. The syntax for a protocol is as follows:-
  \begin{center}
   ...
   \end{center}
The input sequential types and input concurrent types are optional. Type definitions are given by composing the built-in channel types.
