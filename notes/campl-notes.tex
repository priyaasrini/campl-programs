...
\end{varwidth}
\end{center}
{\tt memAccess} uses the {\tt Neg} type to convert an input {\tt Mutex} channel into an output {\tt Mutex} channel, and invoke {\tt memWait}. {\tt memWait} uses the {\tt Neg} type to convert an output {\tt Mutex} channel into an intput {\tt Mutex} channel and invoke {\tt memAccess}.
