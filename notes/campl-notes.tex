...
% maybe change to concurrent constructs?
...
The property of acyclicity at run-time is guaranteed by a type check at compile-time.
...
Processes are the main actors of a CaMPL program. In CaMPL, a {\em process} is specified by a process name and an optional type signature\footnote{\textcolor{purple}{CaMPL does type-inferencing. To write a few more sentences about this.}}. The type signature of a process consists of: 
\begin{itemize}
