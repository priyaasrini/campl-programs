...
\colorbox{green!40}{Keywords:} {\tt plug, put, get} commands, {\tt Put, Get, TopBot} types.

\noindent \colorbox{green!40}{Concepts:} Connecting processes via a channel, one-shot send and receive, closing communication. 
