...
\usepackage{stmaryrd}
\usepackage{tikz}
% this is for the process network diagrams in the appendix so they are the same width as the text.
\usepackage{environ}\makeatletter
...
\lstset{escapeinside={(*@}{@*)}}
\newcommand{\lighten}[1]{(*@ \color{gray}#1 @*)}
...
%\newcommand{\knote}[1]{\todo[inline, inlinewidth=\textwidth, color=lightgray2]{#1}}
\newcommand{\knote}[1]{\par \noindent \colorbox{green!40}{Keywords:} #1} 
\newcommand{\concept}[1]{\par \noindent \colorbox{green!40}{Concepts:} #1}
\newcommand{\highlight}[1]{\par \noindent \colorbox{orange!40}{#1}}

\newcommand{\highlightlabel}[1]{%
  \vspace{0.25em}
  \highlight{\quad #1 \quad}
  \vspace{0.25em}
}
...
\newcommand{\TODO}[1]{{ \tikzset{every picture/.append style={scale=2}, transform shape, strings} \todo[inline, size=large, inlinewidth=\textwidth, color=green!40]{#1}}}
\renewcommand{\note}[1]{{ \tikzset{every picture/.append style={scale=2}, transform shape, strings} \todo[inline, size=large, inlinewidth=\textwidth, color=orange!40]{#1}}}
